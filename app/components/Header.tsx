    ...
    return(
        <div className='py-5 px-5 md:px-12 lg:px-28'>
            <div className="flex justify-between items-center">
                ...
                <button onClick={()=>{router.push('/postitems')}} className=" shadow-[-7px_7px_0px_#000000] flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border boder-solid border-black">
                    Get Started
                </button>
            </div>
            <div className="text-center my-8">
                <h1 className="text-3xl sm:text-5xl font-medium" >Schemes of Work</h1>
                ...
                <form action="" className=' flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-5px_5px_0px_#000000]'>
